...
__all__ = [
    'SRADynamic', 'DISPID_SGRSTText', 'DISPID_SRCEEnginePrivate',
    'SpeechTokenContext', 'DISPID_SpeechPhraseRules',
    'STCLocalServer', 'SPAO_RETAIN_AUDIO',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPIDSPTSI_SelectionOffset', 'SPCT_DICTATION', 'ISpObjectToken',
    'SPINTERFERENCE_TOOLOUD', 'SVP_14', 'SPPS_RESERVED3',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SPEEngineConfidence', 'DISPID_SVAudioOutputStream',
    'SpMMAudioEnum', 'SPRST_INACTIVE', 'SPRECOGNIZERSTATUS',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SGRSTType',
    'ISpeechRecognizerStatus', 'Speech_Max_Word_Length', 'SPAR_Low',
    'SPEI_SR_BOOKMARK', 'DISPID_SRGSetTextSelection', 'ISpeechVoice',
    'DISPID_SLPsItem', 'SPEI_RESERVED5', 'SAFT12kHz8BitMono',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SGRsCount', 'DISPID_SGRSAddSpecialTransition',
    'SGLexicalNoSpecialChars', 'DISPID_SRGetFormat',
    'ISpeechLexiconWords', 'DISPID_SWFEBlockAlign', 'DISPID_SVResume',
    'DISPID_SVEVoiceChange', 'DISPID_SPRuleChildren',
    'SPCT_SUB_DICTATION', 'SPRS_INACTIVE', 'eLEXTYPE_PRIVATE16',
    'ISpeechAudioBufferInfo', 'DISPID_SpeechVoice',
    'DISPID_SLWLangId', 'DISPID_SGRSTWeight', 'SVP_13',
    'ISpeechRecoResult', 'SWPUnknownWordPronounceable',
    'SVEWordBoundary', 'ISpeechFileStream', 'DISPID_SVEBookmark',
    'SPPHRASEPROPERTY', 'SGRSTTWord', 'DISPID_SAFSetWaveFormatEx',
    'SpeechGrammarTagDictation', 'SREPropertyStringChange',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SGRSAddWordTransition', 'SpeechDisplayAttributes',
    'SPRECOSTATE', 'SpVoice', 'SPAUDIOOPTIONS', 'SpObjectToken',
    'DISPID_SABIMinNotification', 'SpeechDataKeyLocation',
    'DISPID_SOTId', 'SpStream', 'DISPID_SGRsCommit',
    'ISpeechPhraseAlternate', 'DISPID_SPPEngineConfidence',
    'SpeechPartOfSpeech', 'ISpeechRecognizer', 'DISPID_SRRTimes',
    'SPWT_PRONUNCIATION', 'SpeechCategoryRecoProfiles',
    'ISpRecoResult', 'DISPID_SWFEChannels', 'SPGS_ENABLED',
    'ISpeechLexicon', 'DISPID_SPPFirstElement', 'SAFT24kHz16BitMono',
    'SPEI_ADAPTATION', 'SAFTGSM610_11kHzMono',
    'SPEI_RECO_OTHER_CONTEXT', 'SVP_8', 'DISPID_SOTSetId',
    'eLEXTYPE_PRIVATE3', 'SPSSuppressWord', 'DISPID_SRIsShared',
    'DISPID_SOTGetDescription', 'SpeechGrammarState',
    'DISPID_SRCPause', 'SASRun', 'SPEI_MIN_SR', 'DISPID_SBSFormat',
    'IStream', 'SpeechRuleState',
    'DISPID_SPPBRestorePhraseFromMemory', 'SREPhraseStart',
    'SP_VISEME_11', 'DISPID_SGRName', 'SPXRO_SML',
    'SpResourceManager', 'SAFTCCITT_uLaw_11kHzMono', 'SVSFlagsAsync',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechPropertyAdaptationOn',
    'DISPID_SRCBookmark', 'ISpPhrase', 'DISPID_SGRSTPropertyId',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SMSGetData',
    'DISPID_SPRuleId', 'SPSMF_SAPI_PROPERTIES', 'DISPID_SGRClear',
    'DISPID_SLPType', 'DISPID_SRCCreateGrammar', 'SpeechInterference',
    'DISPID_SRGRecoContext', 'DISPID_SpeechCustomStream',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRCEBookmark',
    'DISPID_SRCRecognizer', 'DISPID_SOTDisplayUI',
    'DISPID_SPILanguageId', 'SPWORD', 'SpeechEmulationCompareFlags',
    'DISPID_SRRAudioFormat', 'SDTPronunciation', 'ISpeechGrammarRule',
    'DISPID_SRGetPropertyNumber', 'SPDKL_CurrentConfig',
    'SPPARTOFSPEECH', 'ISpEventSink', 'SLODynamic', 'DISPID_SVVolume',
    'SREFalseRecognition', 'SPAUDIOSTATUS', 'SECHighConfidence',
    'DISPID_SOTsCount', 'SpeechTokenShellFolder',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPSEMANTICFORMAT',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SPIStartTime',
    'SPINTERFERENCE_NONE', 'DISPID_SGRSTsItem',
    'SpeechPropertyResponseSpeed', 'SREStreamEnd',
    'DISPID_SRRTOffsetFromStart', 'ISpeechPhraseElement', 'SGDisplay',
    'DISPID_SRGDictationLoad', 'DISPID_SPRules_NewEnum',
    'eWORDTYPE_DELETED', 'DISPID_SVSInputSentencePosition', 'SRARoot',
    'SPWORDTYPE', 'DISPID_SPEsCount', 'SPEI_END_SR_STREAM', 'SVPOver',
    'SpeechGrammarWordType', 'DISPID_SRGetPropertyString',
    'SpSharedRecoContext', 'SPGS_EXCLUSIVE',
    'SpeechVoiceSkipTypeSentence', 'SPEVENTENUM', 'DISPID_SAStatus',
    'DISPID_SRRAudio', 'DISPID_SOTGetAttribute', 'SPVPRI_ALERT',
    'SPWORDLIST', 'SECFIgnoreCase', 'SVEPhoneme', 'DISPID_SVVoice',
    'DISPID_SLWsItem', 'SPEI_RESERVED1', 'SPSERIALIZEDPHRASE',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPSNotOverriden', 'SSTTTextBuffer',
    'DISPID_SGRInitialState', 'SPEI_UNDEFINED', 'SSSPTRelativeToEnd',
    'SPPS_NotOverriden', 'SPPS_RESERVED4', 'SP_VISEME_0',
    'SDTReplacement', 'SP_VISEME_1', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRGId', 'DISPID_SRCEAdaptation', 'SAFTADPCM_22kHzMono',
    'SAFT12kHz16BitMono', 'SPPROPERTYINFO', 'SPWORDPRONUNCIATIONLIST',
    'SpeechRegistryLocalMachineRoot', 'SPEI_INTERFERENCE', 'SLTUser',
    'SRSInactiveWithPurge', 'DISPID_SGRsCommitAndSave', 'STCAll',
    'DISPID_SASNonBlockingIO', 'DISPID_SGRSTransitions',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCState', 'DISPID_SOTIsUISupported',
    'ISpeechRecoResultTimes', 'DISPID_SWFEExtraData',
    'DISPID_SLGenerationId', 'SVSFVoiceMask', 'SPEI_TTS_PRIVATE',
    'SLOStatic', 'STSF_FlagCreate', 'SPSVerb', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SLPLangId', 'SPLO_STATIC', 'DISPID_SRGDictationSetState',
    'ISpObjectTokenCategory', 'SBONone', 'DISPID_SGRs_NewEnum',
    'SPAO_NONE', 'SPFM_CREATE', 'ISpeechPhraseProperty',
    'SAFTADPCM_8kHzMono', 'DISPID_SASCurrentDevicePosition',
    'ISpeechMMSysAudio', 'SREStateChange', 'DISPID_SOTCreateInstance',
    'SAFTCCITT_ALaw_44kHzStereo', 'SRERecognition',
    'ISpeechXMLRecoResult', 'SVSFIsFilename', 'SPDKL_DefaultLocation',
    'DISPID_SpeechPhraseRule', 'SWPKnownWordPronounceable',
    'SPFM_CREATE_ALWAYS', 'SVEAudioLevel', 'DISPID_SVEAudioLevel',
    'SpeechCategoryAudioIn', 'ISpRecognizer', 'eLEXTYPE_PRIVATE7',
    '_ISpeechRecoContextEvents', 'SPSHORTCUTTYPE', 'SRESoundEnd',
    'SAFT32kHz8BitStereo', 'SAFT11kHz16BitStereo',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpNotifySource',
    'DISPID_SOTCSetId', 'eLEXTYPE_PRIVATE6', 'SpeechLexiconType',
    'SRSActiveAlways', 'DISPID_SOTMatchesAttributes',
    'eLEXTYPE_RESERVED7', 'SPXMLRESULTOPTIONS',
    'DISPID_SVSInputWordLength', 'DISPID_SPEsItem', 'SASPause',
    'SAFT11kHz8BitMono', 'DISPID_SPARecoResult', 'DISPID_SVSkip',
    'SPCS_ENABLED', 'DISPID_SRCEventInterests', 'SpLexicon',
    'eLEXTYPE_PRIVATE5', 'DISPID_SRCERecognitionForOtherContext',
    'ISpStreamFormatConverter', 'SGDSInactive', 'ISpeechRecoResult2',
    'SVP_3', '_RemotableHandle', 'ISpRecognizer3',
    'DISPID_SRSetPropertyString', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SpeechPhraseAlternates', 'SAFT32kHz16BitStereo',
    'SPSNoun', 'SpeechVoiceCategoryTTSRate', 'DISPID_SDKEnumValues',
    'SAFTGSM610_44kHzMono', 'SDTAudio', 'LONG_PTR', 'SECFDefault',
    'SPSMF_UPS', 'eLEXTYPE_PRIVATE4', 'DISPID_SPPParent',
    'ISpRecognizer2', 'IInternetSecurityManager',
    'DISPID_SpeechPhraseReplacements', 'ISpVoice',
    'DISPID_SPIElements', 'SAFTText', 'DISPID_SVEventInterests',
    'DISPID_SpeechGrammarRules', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SVGetAudioOutputs', 'DISPID_SVESentenceBoundary',
    'SGPronounciation', 'DISPID_SRRAlternates', 'SPSHORTCUTPAIRLIST',
    'DISPID_SFSOpen', 'DISPID_SVSyncronousSpeakTimeout', 'SGLexical',
    'DISPID_SPACommit', 'SpeechTokenKeyAttributes',
    'DISPID_SVEEnginePrivate', 'SpeechBookmarkOptions',
    'SRAInterpreter', 'SPSHT_Unknown', 'Speech_Default_Weight',
    'DISPID_SMSALineId', 'SWTDeleted', 'DISPID_SRGDictationUnload',
    'eLEXTYPE_APP', 'SAFTADPCM_8kHzStereo', 'DISPID_SGRAddState',
    'SAFTADPCM_44kHzMono', 'SVP_15',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SpeechAudioStatus',
    'SAFT44kHz8BitMono', 'DISPID_SLWType', 'DISPID_SVPriority',
    'ISpeechRecoResultDispatch', 'SpeechCategoryAppLexicons',
    'SRAExport', 'SREStreamStart', 'SPEI_REQUEST_UI',
    'DISPID_SFSClose', 'SAFTNonStandardFormat',
    'SAFT24kHz16BitStereo', 'SPEI_PROPERTY_NUM_CHANGE', 'SRTStandard',
    'SpMMAudioOut', 'SVP_4', 'SP_VISEME_15',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SP_VISEME_10',
    'SDKLLocalMachine', 'DISPID_SVPause', 'DISPID_SLPPartOfSpeech',
    'DISPID_SVEViseme', 'SpPhoneticAlphabetConverter', 'SRCS_Enabled',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SVSpeakCompleteEvent',
    'STCRemoteServer', 'SRADefaultToActive', 'DISPID_SpeechLexicon',
    'DISPID_SOTRemoveStorageFileName', 'SITooLoud', 'SGRSTTDictation',
    'SpInProcRecoContext', 'SpUnCompressedLexicon',
    'DISPID_SPPChildren', 'SAFT22kHz16BitMono',
    'DISPID_SRGCmdLoadFromObject', 'SAFTExtendedAudioFormat',
    'SECLowConfidence', 'SPDATAKEYLOCATION', 'ISpeechDataKey',
    'DISPID_SRGSetWordSequenceData', 'SFTSREngine',
    'ISpeechRecoGrammar', 'DISPID_SAEventHandle',
    'ISpeechTextSelectionInformation', 'ISpeechObjectTokenCategory',
    'SBOPause', 'DISPID_SPPNumberOfElements',
    'ISpeechPhraseProperties', 'DISPID_SRCESoundStart',
    'SAFTCCITT_ALaw_22kHzStereo', 'SAFT22kHz8BitMono', 'SVP_0',
    'SVP_2', 'SPSERIALIZEDRESULT', 'SECFEmulateResult',
    'DISPID_SRGRules', 'ISpSerializeState', 'SPSHORTCUTPAIR',
    'DISPID_SLAddPronunciation', 'SDA_Two_Trailing_Spaces',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SpeechRecognizer',
    'SAFT8kHz8BitMono', 'DISPID_SGRsFindRule', 'DISPID_SpeechAudio',
    'IInternetSecurityMgrSite', 'DISPID_SpeechObjectTokenCategory',
    'SPSInterjection', 'eLEXTYPE_PRIVATE20', 'ISpEventSource',
    'DISPID_SPPValue', 'SPEI_MIN_TTS', 'DISPIDSPTSI_SelectionLength',
    'eLEXTYPE_MORPHOLOGY', 'SPPS_RESERVED1', 'SECNormalConfidence',
    'SRATopLevel', 'SVP_17', 'SDTAlternates', 'DISPID_SPPsCount',
    'SPRS_ACTIVE', 'DISPID_SRGCommit', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SPRNumberOfElements', 'SVP_18', 'DISPID_SPRsCount',
    'ISpRecoContext', 'ISpeechMemoryStream', 'ISpeechWaveFormatEx',
    'SP_VISEME_6', 'DISPID_SpeechPhraseInfo', 'SPBO_AHEAD',
    'SRAONone', 'DISPID_SDKSetBinaryValue', 'eLEXTYPE_USER',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechGrammarTagWildcard',
    'DISPID_SRCEHypothesis', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPRDisplayAttributes', 'SVP_12',
    'DISPID_SVSpeak', 'DISPID_SABIEventBias',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SPRuleConfidence',
    'SVPNormal', 'ISpStreamFormat', 'DISPID_SPRuleName', 'SVP_7',
    'DISPID_SBSRead', 'SVSFNLPMask',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechRecoEvents', 'DISPID_SRCVoice', 'DISPID_SpeechObjectToken',
    'DISPIDSPRG', 'DISPID_SRRTStreamTime', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpeechPhoneConverter', 'DISPID_SPIGetDisplayAttributes',
    'SPEI_START_INPUT_STREAM', 'DISPID_SRCEInterference',
    'SpeechVoiceSpeakFlags', 'SVP_21', 'DISPID_SPRulesCount',
    'SDKLDefaultLocation', 'ISpeechPhraseElements',
    'DISPID_SVSLastStreamNumberQueued', 'SVEStartInputStream',
    'SpWaveFormatEx', 'DISPID_SVWaitUntilDone',
    'DISPID_SRAudioInputStream', 'eLEXTYPE_RESERVED9',
    'DISPID_SOTsItem', 'ISpLexicon', 'SVP_1',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SGRId', 'DISPID_SPIProperties',
    'DISPID_SpeechRecoResult2', 'DISPID_SGRsDynamic',
    'DISPID_SGRSTPropertyName', 'SGDSActive',
    'DISPID_SPRFirstElement', 'SVPAlert', 'SGSExclusive',
    'DISPID_SVGetProfiles', 'SP_VISEME_7', 'SAFT12kHz16BitStereo',
    'SPCT_SLEEP', 'DISPID_SAFType', 'SpNotifyTranslator',
    'SPWORDPRONUNCIATION', 'SINoSignal', 'SPEVENT', 'ISpeechAudio',
    'DISPID_SLGetWords', 'DISPID_SRCCmdMaxAlternates',
    'SPCT_SUB_COMMAND', 'DISPID_SLWs_NewEnum', 'SGSEnabled',
    'DISPID_SGRAddResource', 'DISPID_SRSAudioStatus',
    'DISPID_SDKSetLongValue', 'SpeechRegistryUserRoot',
    'SDA_One_Trailing_Space', 'SAFTGSM610_22kHzMono', 'SPWF_SRENGINE',
    'DISPID_SASState', 'SVP_11', 'SP_VISEME_8',
    'DISPID_SpeechPhraseAlternate', 'SPWORDPRONOUNCEABLE',
    'DISPID_SGRSTNextState', 'DISPID_SVSRunningState', 'SGRSTTRule',
    'SpeechRecoProfileProperties', 'DISPID_SGRSTPropertyValue',
    'SpeechStreamSeekPositionType', 'SpSharedRecognizer',
    'DISPID_SRCEPropertyStringChange', 'SpeechRecognizerState',
    'SINone', 'DISPID_SGRsAdd', 'DISPID_SABufferInfo',
    'eLEXTYPE_PRIVATE2', 'ISpRecoCategory', 'SGSDisabled',
    'DISPID_SRCEAudioLevel', 'SREAdaptation', 'SPSUnknown',
    'DISPID_SDKGetStringValue', 'DISPID_SpeechPhraseProperty',
    'SRESoundStart', 'DISPID_SpeechLexiconWords', 'DISPID_SBSSeek',
    'DISPID_SOTCGetDataKey', 'eLEXTYPE_PRIVATE15',
    'SpeechEngineConfidence', 'SVESentenceBoundary', 'SPRST_ACTIVE',
    'SAFT32kHz16BitMono', 'SpeechDiscardType', 'SPLO_DYNAMIC',
    'DISPID_SPIReplacements', 'DISPID_SGRSTsCount',
    'SAFTNoAssignedFormat', 'SAFT44kHz16BitStereo',
    'DISPID_SPEs_NewEnum', 'ISpNotifyTranslator',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechEngineProperties', 'DISPID_SRGCmdSetRuleState',
    'SP_VISEME_12', 'DISPID_SPPs_NewEnum', 'SPPS_Function',
    'DISPID_SRRSetTextFeedback', 'SRTReSent', 'DISPID_SPAsItem',
    'SPEI_MAX_SR', 'ISpeechPhraseReplacements',
    'DISPID_SRSCurrentStreamPosition', 'SVSFParseSapi',
    'SRCS_Disabled', 'ISequentialStream',
    'DISPID_SVSInputSentenceLength', 'eWORDTYPE_ADDED',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRGState', 'SPINTERFERENCE',
    'ISpeechLexiconPronunciations', 'ISpeechGrammarRuleState',
    'ISpPhraseAlt', 'SRERequestUI', 'DISPID_SVSPhonemeId',
    'Speech_StreamPos_RealTime', 'SPEI_SENTENCE_BOUNDARY',
    'eLEXTYPE_PRIVATE1', 'SPSHT_OTHER', 'eLEXTYPE_RESERVED8',
    'SGRSTTEpsilon', 'DISPID_SDKCreateKey', 'SPWT_LEXICAL',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SPISaveToMemory',
    'SpMMAudioIn', 'SPEI_END_INPUT_STREAM', 'DISPID_SRRPhraseInfo',
    'SP_VISEME_19', 'SPGS_DISABLED', 'DISPID_SPIRule',
    'DISPID_SPPsItem', 'SVP_9', 'DISPID_SVSLastBookmark',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SPRsItem',
    'SDKLCurrentConfig', 'DISPID_SRGCmdLoadFromMemory',
    'ISpeechPhraseInfoBuilder', 'SPGRAMMARWORDTYPE',
    'SPEI_FALSE_RECOGNITION', 'SWPUnknownWordUnpronounceable',
    'SAFT48kHz16BitMono', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SVAlertBoundary', 'SPSHT_EMAIL', 'DISPID_SLPSymbolic',
    'SpMemoryStream', 'DISPID_SRIsUISupported', 'SPAR_Unknown',
    'SPVPRI_NORMAL', 'SPAS_CLOSED', 'UINT_PTR', 'ISpXMLRecoResult',
    'ISpeechObjectToken', 'SAFTCCITT_uLaw_44kHzStereo',
    'SDTDisplayText', 'eLEXTYPE_PRIVATE8',
    'DISPID_SRSetPropertyNumber', 'eLEXTYPE_RESERVED4',
    'SRTSMLTimeout', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SPRText', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SRSCurrentStreamNumber', 'SpPhraseInfoBuilder',
    'DISPID_SRRSaveToMemory', 'SDTProperty',
    'DISPID_SpeechAudioFormat', 'DISPID_SMSADeviceId',
    'ISpeechLexiconPronunciation', 'SRERecoOtherContext',
    'SPLEXICONTYPE', 'SP_VISEME_9', 'SVSFDefault', 'DISPID_SAVolume',
    'DISPID_SMSSetData', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechDictationTopicSpelling', 'DISPID_SASCurrentSeekPosition',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPEAudioStreamOffset', 'SPEI_RECOGNITION',
    'SRTExtendableParse', 'DISPID_SCSBaseStream',
    'SpeechWordPronounceable', 'SPVPRI_OVER', '_SPAUDIOSTATE',
    'SPRST_INACTIVE_WITH_PURGE', 'ISpPhoneticAlphabetConverter',
    'ISpRecoGrammar', 'SPPHRASEREPLACEMENT', 'SRSEDone',
    'SPVOICESTATUS', 'SpeechPropertyNormalConfidenceThreshold',
    'SVSFPersistXML', 'ISpStream', 'SVSFNLPSpeakPunc',
    'DISPID_SRGIsPronounceable', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPBO_PAUSE', 'SPRULE', 'SPGRAMMARSTATE', 'eLEXTYPE_RESERVED10',
    'DISPID_SpeechRecoResultTimes', 'SPFM_OPEN_READWRITE',
    'SAFTDefault', 'SAFTTrueSpeech_8kHz1BitMono', 'SPAR_Medium',
    'SVSFParseMask', 'SpeechUserTraining', 'DISPID_SGRSTRule',
    'SAFT16kHz16BitMono', 'SPBO_NONE', 'DISPID_SPRuleFirstElement',
    'SP_VISEME_20', 'SPEI_HYPOTHESIS', 'SpeechVisemeType',
    'DISPID_SRGCmdLoadFromResource', 'eLEXTYPE_PRIVATE11',
    '__MIDL_IWinTypes_0009', 'SASStop', 'DISPID_SRCRequestedUIType',
    'DISPID_SDKEnumKeys', 'DISPID_SRCEPropertyNumberChange',
    'eLEXTYPE_PRIVATE10', 'SpeechAddRemoveWord',
    'DISPID_SRRRecoContext', 'DISPID_SOTGetStorageFileName',
    'SPEI_WORD_BOUNDARY', 'SPEI_PHRASE_START', 'SRAImport',
    'DISPID_SpeechRecoResult', 'SPFILEMODE', 'ISpeechAudioStatus',
    'SAFT48kHz8BitStereo', 'SpeechAllElements', 'STSF_AppData',
    'SVEVoiceChange', 'SpNullPhoneConverter',
    'SAFTCCITT_ALaw_22kHzMono', 'ISpeechGrammarRules',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechVoiceStatus',
    'DISPID_SpeechAudioBufferInfo', 'SSFMOpenForRead',
    'SPWAVEFORMATTYPE', 'DISPID_SVEPhoneme',
    'DISPIDSPTSI_ActiveLength', 'SPPS_LMA', 'eLEXTYPE_PRIVATE13',
    'SECFNoSpecialChars', 'SPSEMANTICERRORINFO',
    'DISPID_SpeechMemoryStream', 'SP_VISEME_18',
    'DISPID_SRRecognizer', 'SDKLCurrentUser', 'SSSPTRelativeToStart',
    'SVP_19', 'IEnumString', 'ISpShortcut', 'SP_VISEME_21',
    'SPBO_TIME_UNITS', 'SPAS_PAUSE', 'DISPID_SVStatus',
    'SpeechRecoContextState', 'DISPID_SRCEFalseRecognition',
    'SVSFParseAutodetect', 'DISPID_SLGetGenerationChange',
    'SAFT16kHz16BitStereo', 'SPSLMA',
    'SSSPTRelativeToCurrentPosition', 'SPRECORESULTTIMES',
    'SPEI_START_SR_STREAM', 'DISPID_SPIGrammarId',
    'DISPID_SPRs_NewEnum', 'DISPID_SpeechPhoneConverter',
    'SPRST_NUM_STATES', 'DISPID_SOTCategory', 'SPPS_Modifier',
    'SRTAutopause', 'DISPID_SPCIdToPhone', 'DISPID_SRRSpeakAudio',
    'DISPID_SpeechPhraseBuilder', 'SPFM_OPEN_READONLY',
    'ISpeechPhraseRules', 'ISpNotifySink', 'STCInprocHandler',
    'SVSFPurgeBeforeSpeak', 'tagSTATSTG', 'SRAORetainAudio',
    'SPCONTEXTSTATE', 'DISPID_SVSInputWordPosition',
    'DISPID_SREmulateRecognition', 'DISPID_SRCResume',
    'DISPID_SPIEnginePrivateData', 'SVF_None',
    'SpeechPropertyResourceUsage', 'eLEXTYPE_PRIVATE14',
    'SpeechAudioProperties', 'DISPID_SPAPhraseInfo',
    'DISPID_SRRTTickCount', 'SVSFParseSsml', 'eLEXTYPE_VENDORLEXICON',
    'ISpeechPhraseReplacement', 'SVEPrivate', 'SP_VISEME_13',
    'DISPID_SpeechRecoContext', 'DISPID_SDKOpenKey',
    'eLEXTYPE_PRIVATE19', 'DISPID_SVSLastResult', 'SPPS_RESERVED2',
    'SPRULESTATE', 'DISPID_SPRuleNumberOfElements', 'DISPID_SRStatus',
    'DISPID_SPEDisplayAttributes', 'SpeechSpecialTransitionType',
    'SAFT32kHz8BitMono', 'DISPID_SLWPronunciations', 'ISpProperties',
    'DISPID_SASFreeBufferSpace', 'DISPID_SASetState',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRCRetainedAudio',
    'SpeechVisemeFeature', 'SpShortcut', 'SVSFIsXML',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPIAudioStreamPosition',
    'SPVPRIORITY', 'SpeechTokenIdUserLexicon',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SPAStartElementInResult', 'SASClosed', 'SPPHRASE',
    'SRSInactive', 'Speech_StreamPos_Asap', 'SAFT16kHz8BitMono',
    'SPVISEMES', 'SSFMCreateForWrite', 'SREAllEvents',
    'DISPID_SpeechGrammarRule', 'SAFT8kHz8BitStereo', 'SREAudioLevel',
    'SAFT24kHz8BitStereo', 'SAFT44kHz8BitStereo', 'SPEI_SOUND_START',
    'SPEI_RESERVED6', 'SpCompressedLexicon',
    'DISPID_SpeechPhraseElements', 'DISPID_SpeechPhraseElement',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRProfile', 'SREInterference',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpeechResourceLoader',
    'SpeechCategoryRecognizers', 'DISPID_SGRSAddRuleTransition',
    'ISpMMSysAudio', 'SSFMOpenReadWrite', 'SPPS_Unknown',
    'SAFT24kHz8BitMono', 'DISPID_SLPs_NewEnum', 'SP_VISEME_14',
    'DISPID_SpeechFileStream', 'SpeechRecognitionType', 'SP_VISEME_5',
    'DISPID_SWFESamplesPerSec', 'ISpDataKey',
    'DISPID_SPEAudioSizeBytes', 'SpeechRunState',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPCLangId',
    'SpeechTokenValueCLSID', 'SpeechAudioFormatGUIDWave',
    'STSF_LocalAppData', 'DISPID_SABufferNotifySize',
    'DISPID_SLRemovePronunciation', 'SVF_Emphasis',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SRCreateRecoContext',
    'ISpRecoContext2', 'DISPID_SWFEBitsPerSample', 'SPEI_SR_PRIVATE',
    'DISPID_SVAudioOutput', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SGRAttributes', 'SAFT11kHz16BitMono', 'SAFT48kHz8BitMono',
    'ISpeechPhraseInfo', 'ISpeechObjectTokens', 'SITooSlow',
    'DISPID_SPRulesItem', 'STSF_CommonAppData', 'SAFT12kHz8BitStereo',
    'DISPID_SPEActualConfidence', 'SPINTERFERENCE_NOISE',
    'SVF_Stressed', 'SRSActive', 'SpStreamFormatConverter',
    'SPEI_RESERVED3', 'DISPID_SpeechLexiconPronunciation',
    'SpeechTokenKeyUI', 'DISPID_SPCPhoneToId', 'SECFIgnoreKanaType',
    'SPAUDIOBUFFERINFO', 'SDTAll', 'DISPID_SRSSupportedLanguages',
    'SAFT22kHz16BitStereo', 'DISPID_SpeechMMSysAudio',
    'ISpeechBaseStream', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPEVENTSOURCEINFO', 'DISPID_SVEStreamStart', 'SPCT_COMMAND',
    'ISpeechPhraseRule', 'SPEI_RESERVED2', 'SP_VISEME_16',
    'eLEXTYPE_PRIVATE12', 'SVP_6', 'ISpAudio', 'DISPID_SPIEngineId',
    'SPPS_Noncontent', 'DISPID_SPERetainedSizeBytes',
    'SGDSActiveWithAutoPause', 'SpeechLoadOption', 'SWTAdded',
    'SpeechVoiceEvents', 'SpObjectTokenCategory',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SpeechDataKey',
    'SPPS_SuppressWord', 'DISPID_SpeechObjectTokens',
    'DISPID_SRGCmdLoadFromFile', 'SPAUDIOSTATE', 'SPPS_Noun',
    'SREBookmark', 'SP_VISEME_2', 'ISpeechLexiconWord',
    'STCInprocServer', 'DISPID_SRGetRecognizers',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SGRSTTWildcard',
    'SAFTCCITT_uLaw_8kHzMono', 'SPXRO_Alternates_SML',
    'SAFTADPCM_44kHzStereo', 'SPINTERFERENCE_TOOFAST', 'SINoise',
    'SDA_Consume_Leading_Spaces', 'DISPID_SWFEAvgBytesPerSec',
    'SPEI_TTS_BOOKMARK', 'SPINTERFERENCE_TOOSLOW', 'DISPID_SGRsItem',
    'SpeechRuleAttributes', 'DISPID_SDKDeleteKey',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SOTCDefault',
    'DISPID_SRCEPhraseStart', 'ISpGrammarBuilder',
    'eLEXTYPE_PRIVATE17', 'DISPID_SMSAMMHandle', 'SFTInput',
    'DISPID_SVEStreamEnd', 'ISpeechRecoContext', 'DISPID_SPPId',
    'SpeechStreamFileMode', 'DISPID_SABIBufferSize',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRCERequestUI',
    'SpeechAudioFormatType', 'SVSFUnusedFlags',
    'DISPID_SpeechWaveFormatEx', 'SPBOOKMARKOPTIONS',
    'DISPID_SRAudioInput', 'DISPID_SOTDataKey',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SDA_No_Trailing_Space',
    'DISPID_SVGetVoices', 'ISpResourceManager',
    'SGDSActiveUserDelimited', 'SPEI_PHONEME',
    'DISPID_SDKGetlongValue', 'ISpeechCustomStream',
    'SAFT16kHz8BitStereo', 'SpeechWordType', 'DISPID_SVIsUISupported',
    'SLTApp', 'DISPID_SDKGetBinaryValue', 'DISPID_SOTs_NewEnum',
    'DISPID_SRCEEndStream', 'DISPID_SPELexicalForm',
    'ISpeechAudioFormat', 'SAFT8kHz16BitMono', 'SPAS_RUN',
    'DISPID_SpeechPhraseReplacement', 'SVP_20', 'ISpRecoGrammar2',
    'DISPID_SLPsCount', 'SAFTADPCM_22kHzStereo',
    'ISpeechPhraseAlternates', 'DISPID_SVGetAudioInputs',
    'SP_VISEME_17', 'SAFTGSM610_8kHzMono', 'DISPID_SLWWord',
    'DISPID_SPEAudioSizeTime', 'SPPS_Verb', 'SAFT44kHz16BitMono',
    'SREPropertyNumChange', 'SVEAllEvents', 'SpFileStream',
    'DISPID_SLPPhoneIds', 'SITooQuiet', 'SREHypothesis',
    'DISPID_SPRuleParent', 'SPCATEGORYTYPE', 'SITooFast',
    'SPSHT_NotOverriden', 'DISPID_SRRDiscardResultInfo',
    'SAFT48kHz16BitStereo', 'SPRECOCONTEXTSTATUS', 'DISPID_SPPName',
    'SREPrivate', 'DISPID_SPPConfidence', 'SpeechCategoryVoices',
    'DISPID_SRCEStartStream', 'SVEViseme', 'SpCustomStream',
    'DISPID_SADefaultFormat', 'SpeechTokenKeyFiles', 'SP_VISEME_3',
    'SGRSTTTextBuffer', 'SpeechAudioVolume', 'SRTEmulated',
    'SVEBookmark', 'DISPID_SVSLastBookmarkId', 'SPDKL_LocalMachine',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SBSWrite',
    'SAFTADPCM_11kHzMono', 'SVSFIsNotXML', 'SPPHRASERULE',
    'DISPID_SRCERecognizerStateChange', 'SPSModifier', 'SPEI_MAX_TTS',
    'SPBINARYGRAMMAR', 'SPCS_DISABLED', 'DISPID_SPEDisplayText',
    'SVP_16', 'SSTTWildcard', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SDKSetStringValue', 'SpInprocRecognizer',
    'ISpObjectWithToken', 'tagSPTEXTSELECTIONINFO', 'SPLOADOPTIONS',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SVSVisemeId',
    'DISPID_SRCSetAdaptationData', 'DISPID_SRRGetXMLResult',
    'DISPID_SVEWord', 'SpeechMicTraining', 'DISPID_SRRTLength',
    'DISPID_SVSpeakStream', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SVDisplayUI', 'SPADAPTATIONRELEVANCE',
    'SpeechRetainedAudioOptions', 'Speech_Max_Pron_Length',
    'DISPID_SRCESoundEnd', 'DISPID_SWFEFormatTag',
    'SpeechAudioFormatGUIDText', 'SpeechVoicePriority', 'SPAS_STOP',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'tagSPPROPERTYINFO',
    'SPEI_VOICE_CHANGE', 'SPPHRASEELEMENT',
    'DISPID_SRGCmdSetRuleIdState', 'SVP_5', 'eLEXTYPE_USER_SHORTCUT',
    'SPFM_NUM_MODES', 'SPSFunction', 'DISPID_SRCERecognition',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SVEEndInputStream',
    'eLEXTYPE_RESERVED6', 'DISPID_SLWsCount', 'SSTTDictation',
    'SPWF_INPUT', 'DISPID_SRCVoicePurgeEvent', 'SPEI_VISEME',
    'SPTEXTSELECTIONINFO', 'SpTextSelectionInformation',
    'DISPID_SPAsCount', 'SPDKL_CurrentUser',
    'DISPID_SpeechRecoContextEvents', 'ISpPhoneConverter',
    'DISPID_SAFGuid', 'SAFT11kHz8BitStereo', 'SDTLexicalForm',
    'DISPID_SRGReset', 'SpAudioFormat',
    'DISPID_SVSCurrentStreamNumber', 'SpeechCategoryAudioOut',
    'DISPID_SDKDeleteValue', 'SVP_10', 'SAFT22kHz8BitStereo',
    'DISPID_SpeechLexiconWord', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SPIGetText', 'DISPID_SPEPronunciation',
    'eLEXTYPE_PRIVATE18', 'SPAR_High', 'SAFT8kHz16BitStereo',
    'ISpPhoneticAlphabetSelection', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SpeechLexiconProns', 'DISPID_SOTRemove',
    'SpeechAudioState', 'SDTRule', 'DISPID_SGRSRule', 'SSFMCreate',
    '_ISpeechVoiceEvents', 'DISPID_SRCRetainedAudioFormat',
    'SP_VISEME_4', 'DISPID_SLGetPronunciations', 'SECFIgnoreWidth',
    'SpeechFormatType', 'DISPID_SpeechBaseStream',
    'DISPID_SPERequiredConfidence', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SVRate', 'DISPID_SRState',
    'SpeechCategoryPhoneConverters', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SOTCId', 'SpPhoneConverter', 'SPPS_Interjection',
    ...
    'DISPID_SpeechPhraseProperties', 'DISPIDSPTSI',
    'DISPID_SAFGetWaveFormatEx', 'WAVEFORMATEX', 'SPWT_DISPLAY',
    'SPSTREAMFORMATTYPE', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechVoiceStatus', 'SPEI_SOUND_END',
    'DISPID_SRSClsidEngine', 'DISPID_SPAs_NewEnum'
]

_check_version('1.2.1', 1700750864.339820)
